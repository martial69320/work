...
(1,'GM@GM','˚wÉà™óód%’Ï∏€\'†@_O#êVà˜9…˛åK','ˇ\Zö7éÂQ\\Vì0·v_¨Îëòa›V~‚Ui',NULL,NULL,'','dummy value, use `verifier` instead','dummy value, use `salt` instead','GM@GM','2020-08-18 20:09:45','127.0.0.1',0,0,'00','0000-00-00 00:00:00',0,8,0,0,'',0,0,1,1,'','',0,999999,0,'GM@GM','127.0.0.1');
...
insert  into `battlenet_accounts`(`id`,`email`,`sha_pass_hash`,`joindate`,`last_ip`,`failed_logins`,`locked`,`lock_country`,`last_login`,`online`,`locale`,`os`,`LastCharacterUndelete`,`LoginTicket`,`LoginTicketExpiry`,`balans`) values 
